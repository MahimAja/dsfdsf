...
async def create_server_task(interaction):     
    ...
    try:         
        ...
        await interaction.followup.send(embed=discord.Embed(description="## Something went wrong.", color=0xff0000))       
        return      
...
- :bust_in_silhouette:  **SSH:** `{ssh_session_line}`
- :bulb:  **Node ID**: `in-1`

**:bar_chart: Specs:**
- :brain: 64GB RAM 
- :floppy_disk: 1024GB Storage 
- :gear: 16 cores

**:rocket: Quick Start:**
- :mobile_phone: Mobile: Use **Termux** on the Google Play Store.
- :desktop: PC: **USE __Putty__**.

:speech_balloon: **Share Your Experience!**
- Screenshot `neofetch` & post in [Showcase](https://discord.com/channels/1314214371827777567/1330897652740784273).  
- Feedback in [Rate Us](https://discord.com/channels/1314214371827777567/1330897722936524840).  
